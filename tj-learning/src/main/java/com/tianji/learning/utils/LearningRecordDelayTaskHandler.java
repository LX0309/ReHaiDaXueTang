...
public class LearningRecordDelayTaskHandler {
    ...
    //项目启动后   当前类实例化   属性注入之后   方法就会运行     一般用于初始化工作
    @PostConstruct
    public void init(){
        log.info("LearningRecordDelayTaskHandler init方法执行了");
        CompletableFuture.runAsync(this::handleDelayTask);//CompletableFuture  开启新线程执行handleDelayTask方法
    }
    //当前实例类  销毁之前   该方法执行
    @PreDestroy
    public void destroy(){
